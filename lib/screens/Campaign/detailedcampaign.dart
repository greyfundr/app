    ...
    switch (selectedTabIndex) {
      ...
      case 2:
        return const Padding(
          padding: EdgeInsets.symmetric(horizontal: 16),
          child: Text(
            "Exclusive offers for donors: \n\n"
                "• Donors above ₦100,000 will receive a personalized thank-you certificate.\n"
                "• Top contributors will be featured on our official website.\n"
                "• Corporate donors get a partnership badge and social media recognition.",
            style: TextStyle(height: 1.4, color: Colors.black87),
          ),
        );
