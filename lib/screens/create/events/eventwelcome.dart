...
class EventWelcomePage extends StatefulWidget {
  const EventWelcomePage({Key? key}) : super(key: key);

  @override
  State<EventWelcomePage> createState() => _EventWelcomePageState();
}

class _EventWelcomePageState extends State<EventWelcomePage>
