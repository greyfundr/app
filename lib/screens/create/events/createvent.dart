...
class CreateventPage extends StatefulWidget {
  const CreateventPage({Key? key}) : super(key: key);
          ...
          Expanded(
            child: PageView(
              ...
              children: [
                ...
                // Step3(), Step4(), Step5() → coming soon!
                const Center(child: Text("Step 3 - Date & Time", style: TextStyle(fontSize: 24))),
...
class Step1 extends StatefulWidget {
  ...
  const Step1({Key? key, required this.eventData, required this.onNext}) : super(key: key);
  ...
  Widget _roleCard(String title, IconData icon, bool selected, VoidCallback onTap) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        padding: const EdgeInsets.all(20),
        decoration: BoxDecoration(
          color: selected ? Colors.teal.withOpacity(0.1) : Colors.grey[100],
...
class Step2 extends StatefulWidget {
  ...
  const Step2({Key? key, required this.eventData, required this.onNext}) : super(key: key);
