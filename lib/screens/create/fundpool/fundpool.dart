...
class StartFundPoolPage extends StatefulWidget {
  const StartFundPoolPage({Key? key}) : super(key: key);

  @override
  State<StartFundPoolPage> createState() => _StartFundPoolPageState();
}

class _StartFundPoolPageState extends State<StartFundPoolPage> {
